...
class CSGPolygon3D(py4godot_csgprimitive3d.CSGPrimitive3D):
  ...
  @property
  def material(self) -> typing.Union['py4godot_basematerial3d.BaseMaterial3D','py4godot_standardmaterial3d.StandardMaterial3D','py4godot_ormmaterial3d.ORMMaterial3D']:
    r''''''
