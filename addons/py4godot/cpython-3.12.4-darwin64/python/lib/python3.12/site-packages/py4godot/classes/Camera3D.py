...
class Camera3D(py4godot_node3d.Node3D):
  ...
  @functools.native_method
  def get_attributes(self) -> typing.Union['py4godot_cameraattributes.CameraAttributes','py4godot_cameraattributespractical.CameraAttributesPractical','py4godot_cameraattributesphysical.CameraAttributesPhysical']:
    r''''''
