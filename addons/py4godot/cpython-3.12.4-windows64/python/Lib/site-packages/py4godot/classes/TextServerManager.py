...
class TextServerManager(py4godot_object.Object):
  ...
  @functools.native_method
  def get_interface_(self, idx:'int'   ) -> typing.Union['py4godot_textserveradvanced.TextServerAdvanced','py4godot_textserverdummy.TextServerDummy','py4godot_textserver.TextServer','py4godot_textserverextension.TextServerExtension']:
    r'''
  ...
  @functools.native_method
  def find_interface(self, name:'str'   ) -> typing.Union['py4godot_textserveradvanced.TextServerAdvanced','py4godot_textserverdummy.TextServerDummy','py4godot_textserver.TextServer','py4godot_textserverextension.TextServerExtension']:
    r'''
  ...
  @functools.native_method
  def get_primary_interface(self) -> typing.Union['py4godot_textserveradvanced.TextServerAdvanced','py4godot_textserverdummy.TextServerDummy','py4godot_textserver.TextServer','py4godot_textserverextension.TextServerExtension']:
    r'''
