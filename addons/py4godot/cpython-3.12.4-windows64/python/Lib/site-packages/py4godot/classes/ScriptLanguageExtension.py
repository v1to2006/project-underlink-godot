...
'''
  ...
  @functools.native_method
  def _make_template(self, template:'str'   , class_name:'str'   , base_class_name:'str'   ) -> typing.Union['py4godot_scriptextension.ScriptExtension','py4godot_script.Script','py4godot_gdscript.GDScript']:
    r'''
'''
