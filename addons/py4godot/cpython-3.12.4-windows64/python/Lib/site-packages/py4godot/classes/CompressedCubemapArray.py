...
from py4godot.wrappers.wrappers import CPPCompressedCubemapArrayWrapper


class CompressedCubemapArray(py4godot_compressedtexturelayered.CompressedTextureLayered):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = CompressedCubemapArray.construct_without_init()
    class_._ptr = constructor(228,0, ())
    return class_
  @staticmethod
  def new():
    class_ = CompressedCubemapArray.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPCompressedCubemapArrayWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(228,0, ())


  def generate_wrapper(self):
    return CPPCompressedCubemapArrayWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = CompressedCubemapArray.__new__(CompressedCubemapArray)
  ...
  def cast(other:'Object'):
    ...
    cls = CompressedCubemapArray.construct_without_init()
    cls._ptr = CPPCompressedCubemapArrayWrapper()
  ...
  def from_list(values):
    result = CompressedCubemapArray.new0()
    for value in values:
...
register_cast_function('CompressedCubemapArray', CompressedCubemapArray.cast)
register_class('CompressedCubemapArray', CompressedCubemapArray)
